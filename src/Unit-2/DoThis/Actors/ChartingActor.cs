...
namespace ChartApp.Actors
{
    public class ChartingActor : ReceiveActor
    {
        ...
        {
            if (string.IsNullOrEmpty(series.Series.Name) == false &&
                _seriesIndex.ContainsKey(series.Series.Name) == false)
            {
        ...
        {
            if (string.IsNullOrEmpty(series.SeriesName) == false &&
        ...
        {
            if (string.IsNullOrEmpty(metric.Series) == false &&
